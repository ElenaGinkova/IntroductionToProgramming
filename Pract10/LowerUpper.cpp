...
void getLowerAndUpperCount(const char* str, size_t& lowerCount, size_t& upperCount)
{
	if (!str) {
		return;
	}
...
void getLowerAndUpperString(const char* str, char*& lowerString, char*& upperString)
{
	if (!str) {
		return;
	}
